...
public class AwsClientProviderBuilder {
    ...
    private final Map<Class<? extends SdkClient>, Function<Environment, ? extends SdkClient>> factories;
    ...
    public <B extends AwsClientBuilder<B, C>, C extends SdkClient> AwsClientProviderBuilder withClientFactory(Class<C> clientType,
                                                                                                              Function<Environment, C> factory) {
    ...
    public AwsClientProvider build() {
        Map<Class<? extends SdkClient>, Function<Environment, ? extends SdkClient>> clientFactories = ImmutableMap.copyOf(factories);

        return new AwsClientProvider() {

            @Override
            public <T extends SdkClient> T getClient(Class<T> clientType, Environment environment) {
                Function<Environment, ? extends SdkClient> clientFactory = clientFactories.get(clientType);
