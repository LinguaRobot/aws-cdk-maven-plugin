...
public class VpcNetworkContextProviderTest {
                ...
                },
                {
                        Json.createObjectBuilder()
                                ...
                                .add("filter", Json.createObjectBuilder()
                                        .add("filter-1", "filter-1-value")
                                        .add("filter-2", "filter-2-value")
                                        .build())
                                .build(),
    ...
    public void testDescribeVpcsRequest(JsonObject properties, DescribeVpcsRequest expectedRequest) {
        ...
        try {
            new VpcNetworkContextProvider(clientProvider).getContextValue(properties);
        ...
        return new Object[][]{
                ...
                // Asymmetric VPCs: the VPC has one subnetwork of each type: public, private and isolated
                {
                        Json.createObjectBuilder()
                                .add("region", "someRegion")
                                .add("account", "someAccount")
                                .add("returnAsymmetricSubnets", true)
                                .build(),
                        ClientMockData.get()
                                .withVpc(vpc("vpc-1", "1.1.1.1/16"))
                                .withVpnGateway(vpnGateway("vpn-gtw-1", "vpc-1"))
                ...
                // Asymmetric VPCs: specifying group names customized group name tag 'group-name'
                {
                        Json.createObjectBuilder()
                                ...
                                .add("account", "someAccount")
                                .add("returnAsymmetricSubnets", true)
                                .add("subnetGroupNameTag", "group-name")
                                .build(),
                        ClientMockData.get()
                                .withVpc(vpc("vpc-1", "1.1.1.1/16"))
                                .withVpnGateway(vpnGateway("vpn-gtw-1", "vpc-1"))
    ...
    public void test(JsonObject properties, ClientMockData data, JsonObject expectedValue, Class<? extends Exception> exceptionType) {
        Ec2Client ec2Client = mock(Ec2Client.class);
        ...
        VpcNetworkContextProvider contextProvider = new VpcNetworkContextProvider(clientProvider);
